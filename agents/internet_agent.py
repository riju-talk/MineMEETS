...
class InternetAgent:
    ...
    def _build_intelligent_prompt(self, query: str, search_results: List[Dict], context: Optional[Dict] = None) -> str:
...
ANSWER:"""
    ...
    async def quick_fact_check(self, statement: str, context: Optional[Dict] = None) -> Dict[str, Any]:
